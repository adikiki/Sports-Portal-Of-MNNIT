<%-- 
    Document   : reg
    Created on : 19 Apr, 2018, 11:24:05 PM
    Author     : WELCOME
--%>
        ...
        <div id="login-box">
            ...
            <form action="New" method="POST">
               <div class="form-input">
                        ...
                        *<input type="text" name="Regestration" maxlength="10"  placeholder="RegNo" required/><br>
                        ...
                        *<input type="text" name="Race" value="Cycle Race" required />
                       
                        
                        
<!--                        *<select name="Game" align="center" required="required">
                        <option value="">Select running</option>
                        <option value=""></option>
                        <option value="">400m</option>
                        <option value="">800m</option>
                       <option value="">1200m</option>
                       </select> </br>  -->
